                            ...
                            <input type="hidden" name="gambarlama" value="<?= $berita["gambar"]; ?>">
								...
								<div class="row">
									...
									<div class="mb-3 col-md-12">
										...
										<input type="text" name="keterangan" id="keterangan" placeholder="Keterangan" required="required" class="form-control" value="<?php echo $berita["ket"]; ?>">
