  ...
  <hr class="bg-danger fw-bold fixed-top" style="height: 13px; margin: top 15px;">
     ...
     <div class="container-about">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  ...
                  <p class="title-un-des" style="text-align: justify;">Bank Sampah adalah organisasi peduli lingkungan yang berlokasi di .......... Selain bidang bank sampah kami juga berfokus pada pengelolaan sampah, seperti komposting berbasis sampah, dan masih banyak lagi program yang kami kembangkan. Saat ini bank sampah...  melayani warga yang berjumlah lebih dari 100 kepala keluarga. Hal itu menunjukan bahwa warga masyarakat... sangat antusias dengan adanya program ini, dan tentu bank sampah... mendapatkan perhatian khusus dari warga sekitar. Jika Anda berminat untuk bergabung, silahkan ikuti langkah berikut ini</p>
               </div>
            </div>
          </div>
      </div>
      <div class="container-newsletter">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <h3 class="title-un">4 TAHAP BANK SAMPAH </h3>
                  <div class="title-un-icon"><i class="fab fa-accusoft"></i></div>
                  <div class="title-un-des" style="text-align: justify;">4 Tahap Bank Sampah :
                  <ol>
    ...
    <div class="container-about">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <h3 class="title-un">LOKASI BANK SAMPAH </h3>
                  ...
                  <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3946.898248451217!2d119.4796039!3d-5.1482284!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNcKwMDgnNTMuNiJTIDExOcKwMjgnNTUuOCJF!5e0!3m2!1sen!2sid!4v0000000000000!5m2!1sen!2sid" 
                  width="98%" 
                  height="450" 
                  style="border:0;" 
                  allowfullscreen="" 
    ...
    <footer class="footer-distributed" style="width: 100%;">
      ...
      <div class="footer-center">
        ...
        <div>
          ...
          <p><a href="sms:(+62)85749469501">(+62)811111111</a></p>
        </div>
        <div>
          <i class="fa fa-envelope"></i>
          <p><a href="mailto:bank_mliriprowo@gmail.com">bank_sampah@gmail.com</a></p>
        </div>
      </div>
