...
$biodata = query("SELECT * FROM users WHERE idUser = '$id'")[0];
    ...
    // Query untuk mengambil nama dan gambar pengguna
    $query = "SELECT namaUser, gambar FROM users WHERE idUser = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        $username = $user['namaUser']; // Nama pengguna
        $profile_picture = "img/user/" . $user['gambar']; // Path ke foto profil
    } else {
        $username = "Unknown User";
        $profile_picture = "images/default_profile.jpg"; // Gambar default
    }
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="user2.php" class="brand-logo">
        ...
        <!--**********************************
            Header start<img src="img/user/<?= $biodata["gambar"]  ?>
        ***********************************-->
        <div class="header">
            <div class="header-content">
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <!-- Dropdown Profil di Paling Kanan dengan Foto -->
                        <li class="nav-item ps-3">
                            <div class="dropdown header-profile2">
                                <a class="nav-link d-flex align-items-center" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <!-- Profil dengan gambar bundar dan nama -->
                                    <div class="d-flex align-items-center">
                                        <img src="img/user/<?= $biodata["gambar"]  ?>
                                        <img src="<?php echo $profile_picture; ?>" alt="Profile Picture" class="rounded-circle" style="width: 40px; height: 40px; object-fit: cover; border: 2px solid #fff;">
                                        <span class="ms-2 text-light font-weight-bold" style="font-size: 14px;"><?php echo $biodata["namaUser"]; ?></span>
                                    </div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a href="user1.php" class="dropdown-item">
