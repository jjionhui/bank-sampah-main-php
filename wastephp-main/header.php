...
<!-- Mirrored from w3crm.dexignzone.com/xhtml/employee.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 31 Jul 2023 03:46:45 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="admin1.php" class="brand-logo">
								...
								<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
									<div class="header-info2 d-flex align-items-center">
										<div class="header-media">
											<img src="images\avatar\1.png" alt="" class="avatar avatar-sm">
										</div>
										<div class="header-info ms-2">
											<h6 class="text-light mb-0">Administrator |</h6>
										</div>
									</div>
								</a>
